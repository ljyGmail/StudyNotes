...
public class OneArrayTest1 {
    public static void main(String[] args) {
        ...
        if (arr4[0] == '\u0000') {
            System.out.println("333"); // 输出
        }

        System.out.println(arr4[0] + 1); // 1
        ...
        for (int i = 0; i < arr6.length; i++) {
            System.out.println(arr6[i]); // 5个null
        }

        if (arr6[0] == null) {
            System.out.println("aaa"); // 输出
        }
